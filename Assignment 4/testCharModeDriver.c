...
int main(void) {
	...
	printf("\nTesting max read/write with 'UCF'\n");
	char stringToSend13[BUFFER_LENGTH];
	strncpy(stringToSend13, "", BUFFER_LENGTH);

	ret = write(fd, stringToSend13, strlen(stringToSend13));
	if (ret < 0){
		perror("Failed to write the message to the device.");
		return errno;
	}
